            ...
            if (a.length < 16) Ga(Number(a));
              ...
              for (var e = b, f = ((d - b) % 6) + b; f <= d; e = f, f += 6)
                (e = Number(a.slice(e, f))),
                  ...
                  (M = M * 1e6 + e),
                  M >= 4294967296 &&
                    ((N += Math.trunc(M / 4294967296)), (N >>>= 0), (M >>>= 0));
              b &&
                ((b = n(Ha(M, N))),
                (a = b.next().value),
                (b = b.next().value),
